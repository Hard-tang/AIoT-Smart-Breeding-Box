...
int x_last = 1000;                          //x轴基于上一次需要移动的位置
int y_last = 1000;                          //y轴基于上一次需要移动的位置
...
int crawl_First_hight[2] = {2000, 3000};      //第一层机械手抓取和运动的安全高度
int crawl_Second_hight[2] = {10000, 12000};      //第二层机械手抓取和运动的安全高度
uint8_t First_flag = 0;
uint8_t Second_flag = 0;

int Middle_aisle[4] = {200, 9000};                                      //仅记住中间点的X,Y坐标，Z的坐标需要根据到时候在那一层来取反。
int First_normal[7] = { 1000, 800, 3000, 2900};             //第一层常态化区域的其中两盆需要抓取的坐标。x,y.x,y,z为常规高度
int Second_normal[7] = {1000, 800, 3000, 2900};                  //第二层常态化区域的其中两盆需要抓取的坐标。x,y.x,y,z
int First_different[5] = {1000, 11200, 3000, 14000};            //第一层异层区域的其中两盆需要抓取的坐标。x,y.x,y,z
int Second_different[5] = {1000, 11200, 3000, 14000};           //第二层异层区域的其中两盆需要抓取的坐标。x,y.x,y,z
